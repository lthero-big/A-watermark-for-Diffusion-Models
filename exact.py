...
def exactract_latents(args):
    ...
    # 图像路径
    orig_image_path = args.orig_image_path
    # 格式PIL.Image.Image
...
if __name__ == "__main__":
    ...
    parser.add_argument('--original_message_hex', default="6c746865726f6c746865726f6c746865726f6c746865726f6c746865726f6c74")
    parser.add_argument('--num_inference_steps', default=100)
    parser.add_argument('--l', default=1, help="the size of slide windows for m")
